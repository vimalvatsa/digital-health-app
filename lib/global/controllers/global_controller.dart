...
class GlobalController extends GetxController {
  ...
  Future<void> setProfile(CollectionReference usersRef, User? user,
      RegistrationPageController controller) async {
  ...
  Future<void> getProfile(CollectionReference usersRef, User? user) async {
