...
class MyApp extends StatelessWidget {
  ...
  dynamic put() => Get.put(RegistrationPageController());
  ...
  MaterialColor accentColour =
      MaterialColor(0XFF79397E, <int, Color>{50: Color(0XFF79397E)});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/profile': (context) => PrescriptionPage(),
      },
    );
  }
